...
input_path1=f"simplify_rela_entity_train_solution9_implicit_1_6000_dev.json"
input_path2=f"annotated_train_faith.json"

output_path=f"solution9_relation_entity_train_merged.json"
...
for item in new_Relation:
    try:
        ...
        current_data_item["silver_tsf"]["entity"] = entity
